...
- Modellvergleiche durch Bayes Factors
...
## Was ist Bayesianische Statistik?


- Es ist wichtig, zwischen Parameterschätzung und Hypothesentest zu unterscheiden.
- Hypothesentest einen Vergleich zwischen mehreren Modellen - daher ist es komplizierter als die Schätzung.
...
Wir können die Bayes'sche Regel umformulieren, so dass die Abhängigkeit der Parameter $\mathbf{\theta}$ vom Modell $\mathcal{M}$) eindeutig ist:
$$ 
