...
Nun möchten wir testen, ob sich die Bedingungen "Pfeil zeigt nach rechts" und "Pfeil zeigt nach links" in Bezug auf den Bias (`c`) unterscheiden. 

Dafür nutzen wir die Stärken eines bayesianischen t-Tests, wie  [hier](https://kogpsy.github.io/neuroscicomplabFS23/pages/chapters/bayesian-statistics-2.html) behandelt.
