...
Was wir hier machen ist eigentlich einfach. Um die `within` Standardfehler zu berechnen, müssen wir zuerst die personen-spezifische Mittelwerte von den Daten subtrahieren. Dies können wir mit der Funktion `normDataWithin()` machen.
